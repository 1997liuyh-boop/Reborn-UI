<template>
    <view :class="ui.wrapper({ class: props.class })" :data-disabled="isDisabled">
...
import theme, { inputNumberColors, inputNumberSizes, inputNumberShapes } from "./re-input-number.config";
