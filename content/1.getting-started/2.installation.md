...
本指南将帮助您在 Vue 或 Nuxt 应用程序中安装和设置 Reborn UI 组件。
::code-group
...
::alert{type="warning" title="对于 UniApp 用户"}
如果您使用的是 UniApp, [安装与配置 tailwindcss](https://tw.icebreaker.top/docs/quick-start/install).
::
