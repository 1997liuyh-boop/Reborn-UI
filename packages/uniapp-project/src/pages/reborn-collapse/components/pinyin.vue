...
<template>
  <view>
    ...
    <view class="flex flex-wrap justify-center gap-x-1">
      <view
        v-for="(t, j) in titleTokens" :key="j" class="
    ...
    <view class="mt-4 flex flex-wrap justify-center gap-x-1">
      <view
        v-for="(t, j) in authorTokens" :key="j" class="
          flex flex-col items-center
        "
      >
        <view
    ...
    <view class="mt-4 flex flex-wrap gap-x-0.5 px-4">
      <view
        v-for="(t, j) in prefaceTokens" :key="j" class="
          flex flex-col items-center
        "
      >
        <view
        ...
        <view
          class="
            text-[13px] leading-tight text-gray-500
            dark:text-gray-1
          "
        >
          {{ t.ch }}
    ...
    <view class="mt-6 flex flex-col items-center gap-y-2">
      <view
        v-for="(lineTokens, i) in linesTokens" :key="i" class="
          flex flex-wrap justify-center gap-x-1
        "
      >
        <view
          v-for="(t, j) in lineTokens" :key="j" class="
            flex w-8 flex-col items-center
          "
        >
          <!-- 拼音 -->
          <view
          ...
          <view
            class="
              font-serif text-base leading-none text-gray-700
              dark:text-gray-2
            "
          >
            {{ t.ch }}
