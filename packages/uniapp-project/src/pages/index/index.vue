...
const menuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: '日期选择器', icon: 'i-lucide-calendar', path: '/pages/reborn-select-date/RebornSelectDateDemo' },
      {
        label: '评分',
        icon: 'i-lucide-star',
  ...
  },
  {
    ...
    children: [
      ...
      { label: '变体标签', icon: 'i-lucide-bookmark', path: '/pages/reborn-variant-tag/RebornVariantTagDemo' },
