...
<template>
    <RebornPage title="复选框 (Checkbox)" description="交互式复选框组件，支持布尔值或多选。">
        ...
        <RebornCard title="组合视图" custom-class="space-y-3">
            <view class="text-sm text-slate-600 dark:text-slate-200">已选: {{ groupValues }}</view>
            ...
            <view class="flex flex-col gap-3">
                <RebornCheckbox v-model="groupValues" value="基础版" :ui="{
                    ...
                    <view class="flex flex-col gap-1">
                        <text class="font-bold text-slate-900 dark:text-slate-100">基础版</text>
                        <text class="text-sm text-slate-500 dark:text-slate-200">适合快速接入的轻量配置。</text>
                    </view>
                </RebornCheckbox>
                ...
                <RebornCheckbox v-model="groupValues" value="标准版" color="error" :ui="{
                    ...
                    <view class="flex flex-col gap-1">
                        <text class="font-bold text-slate-900 dark:text-slate-100">标准版</text>
                        <text class="text-sm text-slate-500 dark:text-slate-200">涵盖常用场景的均衡方案。</text>
                    </view>
                </RebornCheckbox>
                ...
                <RebornCheckbox v-model="groupValues" value="旗舰版" color="neutral" :ui="{
                    ...
                    <view class="flex flex-col gap-1">
                        <text class="font-bold text-slate-900 dark:text-slate-100">旗舰版</text>
                        <text class="text-sm text-slate-500 dark:text-slate-200">完整能力组合，满足复杂业务。</text>
                    </view>
                </RebornCheckbox>
            </view>
        </RebornCard>
