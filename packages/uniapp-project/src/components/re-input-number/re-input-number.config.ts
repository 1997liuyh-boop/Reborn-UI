...
export default {
  slots: {
    wrapper:
      "relative inline-flex items-center overflow-hidden bg-white text-gray-8 ring-1 ring-gray-2 transition-colors focus-within:ring-2 data-[disabled=true]:cursor-not-allowed data-[disabled=true]:bg-gray-1 data-[disabled=true]:text-gray-4 dark:bg-gray-800 dark:text-gray-200 dark:ring-gray-700 dark:data-[disabled=true]:bg-gray-900 dark:data-[disabled=true]:text-gray-600",
    button:
  ...
  variants: {
    size: {
      sm: {
        ...
        input: "w-[calc(var(--text-size-26)*3)] text-[length:var(--text-size-26)]",
        button: "p-1.5",
        icon: "size-3.5",
      },
      md: {
        wrapper: "h-[calc(var(--text-size-28)*2)] text-[length:var(--text-size-28)]",
        input: "w-[calc(var(--text-size-26)*5)] text-[length:var(--text-size-28)]",
        button: "p-2",
        icon: "size-4",
      },
      lg: {
        wrapper: "h-[calc(var(--text-size-32)*2)] text-[length:var(--text-size-32)]",
        input: "w-[calc(var(--text-size-26)*7)] text-[length:var(--text-size-32)]",
        button: "p-2.5",
        icon: "size-5",
      },
    },
