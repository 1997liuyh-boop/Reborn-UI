...
const gridItems = [
  {
    ...
    description:
      "Open up Reborn UI to discover so many features, you’ll wonder if you’ve wandered into a magical subscription for infinite goodies.",
  },
  {
    ...
    description:
      "We packed Reborn UI with enough customizable settings to keep you tweaking forever. If it’s broken, you probably forgot to flip one more switch!",
  },
  {
    ...
    description:
      "Forget dull interfaces—Reborn UI brings your Vue and Nuxt apps to life with animations so smooth, you’ll wonder!",
  },
  {
    ...
    description:
      "Make your interface shine brighter than your future. Reborn UI turns that dull design into an enchanting experience—fairy dust included!",
  },
  {
...
<template>
  <ul
    ...
    <li v-for="item in gridItems" :key="item.title" class="min-h-[14rem] list-none" :class="[item.area]">
        ...
        <div
          ...
          <div class="relative flex flex-1 flex-col justify-between gap-3">
            <div class="w-fit rounded-lg border border-gray-600 p-2">
              <Icon class="size-4 text-black dark:text-neutral-500" :name="item.icon" />
            </div>
            <div class="space-y-3">
              <h3
