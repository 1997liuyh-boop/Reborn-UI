...
<template>
  <div class="flex w-full min-w-0 flex-col">
    <Playground v-model="state" :controls="controls" component-name="RebornBreadcrumb" title="交互演练场"
    ...
    <DemoSection title="分隔符定制" description="separator 传文本、separator-icon 传图标；条目上的同名属性与 #separator 插槽优先级更高。">
      <DemoBlock layout="grid" align="start">
        <div class="flex flex-col gap-3">
          <span class="text-dimmed text-xs font-medium">容器文本 · <code>separator</code></span>
        ...
        <div class="flex flex-col gap-3">
          <span class="text-dimmed text-xs font-medium">容器图标 · <code>separator-icon</code></span>
        ...
        <div class="flex flex-col gap-3">
          <span class="text-dimmed text-xs font-medium">条目属性 · <code>separator</code></span>
          <RebornBreadcrumb separator="/">
            <RebornBreadcrumbItem to="/">首页</RebornBreadcrumbItem>
        ...
        <div class="flex flex-col gap-3">
          <span class="text-dimmed text-xs font-medium">条目插槽 · <code>#separator</code></span>
          <RebornBreadcrumb>
            <RebornBreadcrumbItem to="/">首页</RebornBreadcrumbItem>
    ...
    <DemoSection title="routes 数据驱动" description="传入 routes 后由组件渲染条目；item-render 插槽可接管单项内容，custom-url 可改写跳转地址。">
      <DemoBlock layout="stack">
        ...
        <DemoNote tone="dimmed">
          第二组用 <code>#item-render</code> 自定义了每一项的内容，作用域参数包含 <code>route</code>、<code>routes</code> 与 <code>paths</code>。
        </DemoNote>
      </DemoBlock>
    </DemoSection>
    ...
    <DemoSection title="超出折叠" description="max-count 指定最多展示的条目数量，超出部分折叠为省略号，始终保留首项与末尾若干项。">
      <DemoBlock layout="stack">
        ...
        <DemoNote tone="dimmed">第二组用 <code>#more-icon</code> 替换了默认的省略号图标。</DemoNote>
      </DemoBlock>
    </DemoSection>
