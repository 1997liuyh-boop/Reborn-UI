...
<template>
  <div class="flex w-full flex-col gap-10">
    ...
    <div class="grid gap-8">
      <div class="space-y-4">
        <h3 class="text-base font-medium text-gray-400">基础</h3>
      ...
      <div class="space-y-4">
        <h3 class="text-base font-medium text-gray-400">功能</h3>
        <div class="grid gap-4 md:grid-cols-2">
          <RebornInput :size="size" placeholder="请输入内容">
            <template #leading>
          ...
          <RebornInput :size="size" placeholder="请输入内容">
            <template #trailing>
              <span class="text-xs text-gray-6">已输入</span>
            </template>
          </RebornInput>
        </div>
      </div>
      ...
      <div class="space-y-4">
        <h3 class="text-base font-medium text-gray-400">多行输入框</h3>
