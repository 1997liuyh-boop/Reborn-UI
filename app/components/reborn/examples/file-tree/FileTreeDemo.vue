...
import type { TreeViewElement } from "~/components/content/reborn/ui/file-tree/index";
...
<template>
  <Tree class="bg-background overflow-hidden rounded-md p-2" initial-selected-id="1" :initial-expanded-items="[
    '1',
    '2',
    '3',
    '4',
