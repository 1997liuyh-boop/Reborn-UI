  ...
  <div class="max-w-6xl mx-auto px-6 py-12 space-y-16">
    ...
    <Playground v-model="state" :controls="controls" component-name="RebornDialog" title="交互体验"
      ...
      <RebornDialog v-bind="state" @confirm="() => console.log('Confirm clicked')"
        ...
        <RebornButton label="打开对话框" color="primary" variant="solid" shadow="md" />
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section
          ...
          <RebornDialog v-model:open="nestedOpen1" title="第一层对话框" description="您可以点击下方按钮开启更深一层的交互。">
            <RebornButton label="开启嵌套流程" color="neutral" variant="outline" class="w-full justify-center py-6" />
        ...
        <section
          ...
          <RebornDialog title="用户服务协议" scrollable description="更新日期：2026年3月">
            <RebornButton label="阅读协议详情" color="neutral" variant="soft" class="w-full justify-center py-6" />
        ...
        <section
          ...
          <RebornDialog v-model:open="asyncOpen" title="同步云端设置" description="正在将您的配置上传至私有云端节点..."
            ...
            <RebornButton label="执行同步" color="secondary" variant="soft" class="w-full justify-center py-6" />
        ...
        <section
          ...
          <div class="grid grid-cols-2 gap-4">
            <RebornDialog title="自由拖拽" draggable description="按住标题区域即可平移位置。">
              <RebornButton label="拖拽演示" variant="outline" class="justify-center border-dashed" />
              <template #content>
            ...
            <RebornDialog title="精简模式" :ui="{
              ...
              <RebornButton label="自定义 UI" variant="outline" class="justify-center border-dashed" />
              <template #content>
                <div
