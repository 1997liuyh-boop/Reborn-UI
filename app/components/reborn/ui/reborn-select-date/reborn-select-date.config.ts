...
export default {
  slots: {
    ...
    dropdown:
      "absolute z-50 mt-1 w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-lg p-3",
    calHeader: "flex items-center justify-between mb-2",
    calNavBtn:
      "p-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer text-gray-600 dark:text-gray-300",
