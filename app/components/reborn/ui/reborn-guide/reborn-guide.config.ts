...
export default {
  slots: {
    ...
    /** 指引框容器 */
    guideBox:
      "fixed z-[--guide-box-z] bg-white dark:bg-gray-9 rounded-3xl shadow-xl border border-gray-2 dark:border-gray-7 min-w-[260px] max-w-[360px]",
    /** 指引框箭头 */
    ...
    guideBody: "px-5 py-2 text-sm text-gray-6 dark:text-gray-3",
    /** 指引框底部 */
    ...
    counter: "text-sm text-gray-4 dark:text-gray-5",
    /** 按钮组 */
    ...
    /** dialog 模式：对话框 */
    dialogBox:
      "bg-white dark:bg-gray-9 rounded-3xl shadow-xl w-full max-w-[480px]",
  },
  variants: {
    mode: {
      popup: {},
