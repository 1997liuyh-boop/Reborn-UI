...
export default {
    slots: {
        ...
        trigger: 'relative z-10 inline-flex items-center justify-center gap-2 whitespace-nowrap px-3 py-2 text-32 font-medium text-gray-7 ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 flex-1',
        ...
        indicator: 'absolute bottom-0 left-0 h-1.5 w-0 rounded-full transition-all duration-300 ease-in-out z-0 opacity-90 -translate-y-1'
    },
    variants: {
        type: {
            line: {
        ...
        variant: {
            primary: {
                ...
                indicator: 'bg-[linear-gradient(90deg,var(--color-red-6),var(--color-orange-6),var(--color-blue-6),var(--color-green-6))] bg-[length:200%]'
            },
            info: {
        ...
        orientation: {
            ...
            vertical: {
                ...
                indicator: 'hidden',
                content: 'flex-1 w-full h-full overflow-y-auto mt-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]'
            }
        },
        size: {
            sm: {
