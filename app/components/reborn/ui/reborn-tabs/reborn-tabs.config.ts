...
export default {
  slots: {
    ...
    trigger:
      "relative z-10 inline-flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap px-3 py-2 text-lg font-medium text-gray-7 ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 flex-1",
    leadingIcon: "flex items-center text-base",
    leadingAvatar: "flex items-center overflow-hidden rounded-full",
    leadingAvatarSize: "h-6 w-6",
    label: "relative z-10",
    trailingBadge: "flex items-center rounded-full bg-gray-2 px-2 py-0.5 text-sm text-gray-7",
    trailingBadgeSize: "text-sm",
    content:
  ...
  variants: {
    ...
    size: {
      sm: {
        trigger: "text-base px-2.5 py-1.5",
        leadingAvatarSize: "h-5 w-5",
        trailingBadgeSize: "text-sm",
      },
      md: {
        trigger: "text-lg px-3 py-2",
        leadingAvatarSize: "h-6 w-6",
        trailingBadgeSize: "text-sm",
      },
      lg: {
        trigger: "text-xl px-4 py-2.5",
