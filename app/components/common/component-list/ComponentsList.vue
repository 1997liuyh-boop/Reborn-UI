...
<template>
  <div class="relative flex w-full flex-col items-center justify-center gap-8 p-8 max-lg:p-6">
    ...
    <div class="mt-4 flex flex-wrap items-center justify-center gap-3">
      <UButton v-for="category in categories" :key="category" :label="category" :active="selectedCategory === category"
        active-variant="solid" active-color="primary" variant="subtle" :color="getCategoryColor(category)"
        class="rounded-full px-4 py-3 lowercase" size="lg" :ui="{
          base: [
