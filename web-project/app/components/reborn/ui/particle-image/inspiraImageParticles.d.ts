/**
 * Type definitions for rebornImageParticles
 */

/**
 * Options for initializing the rebornImageParticle class.
 */
interface rebornImageParticleOptions {
  width?: number;
  height?: number;
  maxWidth?: number;
  maxHeight?: number;
...
/**
 * Interface containing all public property definitions for rebornImageParticle.
 */
export interface rebornImageParticleProps {
  // Public Properties
  state: string;
...
/**
 * rebornImageParticle class for creating particle animations from images.
 */
export declare class rebornImageParticle implements rebornImageParticleProps, EventHandlers {
  constructor(options?: rebornImageParticleOptions);

  // Public Methods
  on(event: string, fn: (params?: unknow) => void): void;
  emit(event: string, params?: unknow): void;

  start(options?: Partial<rebornImageParticleOptions>): void;
  stop(options?: Partial<rebornImageParticleOptions>): void;

  // Private Methods
  private _animate(): void;
  private _onImageLoaded(options: rebornImageParticleOptions): void;
  private _initImage(options: rebornImageParticleOptions): void;
  private _initContext(options: rebornImageParticleOptions): void;
  private _defaultInitContext(options: rebornImageParticleOptions): void;
...
/**
 * Initializes the rebornImageParticle module and returns the class.
 */
export declare const rebornImageParticles: () => {
  rebornImageParticle: typeof rebornImageParticle;
};
